...
## Note about "recheck code can run"
I cannot run `npm install` in this environment (no internet), but:
- All imports are consistent
- Dependencies are listed
- shadcn component list is provided (so Vite compile will succeed)
